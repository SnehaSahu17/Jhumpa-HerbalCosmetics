...
function Aboutus() {
  return (
    <div className="pt-10 pb-10 md:pb-40 md:pt-0">
      <div className="w-[90vw] h-fit  flex flex-col justify-start items-center mx-auto">
        ...
        <div className="md:mt-16 grid grid-cols-1 md:grid-cols-2 gap-x-24 2xl:gap-x-44 gap-y-10 mx-auto">
          <img
            src="https://res.cloudinary.com/dkqxnquga/image/upload/v1689962033/Asset_4_4x_swflwi.png"
            className="w-56 h-96 2xl:w-[345px] 2xl:h-[627px]" alt="aboutus"
          ></img>
        ...
        <p className="text-black mt-10 md:mt-24 text-justify md:text-center text-lg md:text-2xl 2xl:text-3xl font-normal xl:leading-[43px] xl:tracking-[-0.9px]">
