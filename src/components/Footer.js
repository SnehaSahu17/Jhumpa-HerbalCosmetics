...
function Footer() {
  return (
    <div className="w-full h-fit bg-[#173D28]  grid grid-cols-1 xl:grid-cols-3  px-auto px-32 xl:pl-28 xl:pr-36 pb-28 mx-auto gap-x-40 pt-28  gap-y-10">
      <div className="flex flex-col gap-14 w-full ">
        <img
          src="https://res.cloudinary.com/dkqxnquga/image/upload/v1689939043/Layer_4_zbghnc.png"
          className="w-[75%] h-40 "
        ></img>
        <p className=" text-white font-lato text-3xl font-semibold leading-[43px] tracking-[-0.9px] text-justify w-[80%]">
      ...
      <div className="flex flex-col w-full pt-10">
        <div className="pb-10 text-left flex flex-col gap-2 text-white font-lato">
          <h1 className="text-5xl font-bold leading-[43px] tracking-[-1.44px] ">
            Contact us
          </h1>
          <p className="text-3xl font-semibold leading-[43px] tracking-[-0.9px]">
      ...
      <div className="flex  pt-10 justify-between w-full relative ">
        <div className="text-white  text-left font-lato leading-[43px] tracking-[-0.9px]">
          <h1 className="text-4xl font-bold tracking-[-1.44px] pb-4 w-2/3">
            Manufactured & Marketed by
          </h1>
          <div className="flex flex-col gap-y-2 text-3xl font-semibold ">
