...
function Items({id,link,text}) {
  return (
    ...
    >
      ...
      <p className="text-[#173D28] text-left font-lato text-xl 2xl:text-3xl font-normal capitalize 2xl:leading-[43px] 2xl:tracking-[-0.3px] mt-7 mb-10 sm:mb-3 xl:pr-24 2xl:pr-28">
        {text}
      </p>
    </div>
  );
