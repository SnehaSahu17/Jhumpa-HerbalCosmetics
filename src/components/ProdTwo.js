...
function ProdTwo() {
  return (
    <div className="pb-10 md:pt-0 md:pb-40">
      <div className="w-[90vw] h-fit grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-10 mx-auto rounded-3xl border-solid border-white border-2 products lg:pl-20 lg:pr-4 px-2 py-10 xl:py-24">
        <div className="flex flex-col items-start justify-center md:py-10 ">
          ...
          <img
            src="https://res.cloudinary.com/dkqxnquga/image/upload/v1689970518/hair_oil_ilruuy.png"
        ...
        <div className="bg-[#F4F5EC] relative rounded-full p-8 md:p-0 my-10 sm:my-auto h-80 xl:h-[500px] 2xl:h-[594px] w-80 xl:w-[500px] 2xl:w-[594px] mx-auto">
          <div className=" ml-28 xl:ml-44 w-1/5 h-80  xl:h-[500px] 2xl:h-[594px] bg-[#797B14]  blur-[47px]"></div>
          <img
            src="https://res.cloudinary.com/dkqxnquga/image/upload/v1689970519/image-removebg-preview_2_-transformed_1_vtjvqi.png"
